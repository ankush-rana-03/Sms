...
// Legacy assignment function - deprecated
// Use the new TeacherAssignment model and routes instead
exports.assignClassesToTeacher = async (req, res) => {
  res.status(410).json({
    success: false,
    message: 'This endpoint has been deprecated. Please use the new assignment system at /api/admin/assignments',
    newEndpoint: '/api/admin/assignments'
  });
};
