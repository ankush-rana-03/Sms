...
class EmailService {
  ...
  async sendAdminPasswordResetEmail(teacherData, newPassword) {
    try {
      ...
      const mailOptions = {
        from: `"${process.env.SCHOOL_NAME || 'School Management System'}" <${process.env.EMAIL_USER}>`,
        to: email,
        subject: `Password Reset - ${process.env.SCHOOL_NAME || 'School Management System'}`,
        html: this.generateAdminPasswordResetEmailHTML({
          name,
          email,
          designation,
          teacherId,
        ...
        <div class="container">
          ...
          <div class="user-info">
            ...
            <div class="info-row">
              ...
              <span class="info-value">${role.charAt(0).toUpperCase() + role.slice(1)}</span>
            </div>
            <div class="info-row">
          ...
          <div class="important-note">
            ...
            <ul style="margin: 10px 0; padding-left: 20px;">
              <li>If you did not change your password, please contact the IT department immediately.</li>
          ...
          <ul>
            ...
            <li><strong>Review Security:</strong> Ensure your account information is up to date</li>
            <li><strong>Contact Support:</strong> If you have any issues accessing your account</li>
            <li><strong>Stay Updated:</strong> Keep your contact information current</li>
          </ul>
  ...
  // Generate HTML content for admin password reset email
  generateAdminPasswordResetEmailHTML(data) {
    const {
      name,
      email,
      designation,
    ...
    return `
      ...
      <body>
        <div class="container">
          <div class="header">
            <div class="school-name">${process.env.SCHOOL_NAME || 'School Management System'}</div>
            <div class="notification-message">🔐 Password Reset Notification</div>
          </div>

          <p>Dear <strong>${name}</strong>,</p>

          <p>Your password for the <strong>${process.env.SCHOOL_NAME || 'School Management System'}</strong> has been reset by the administrator.</p>

          <p>Please use the new password provided below to access your account:</p>

          <div class="teacher-info">
            <h3 style="color: #ff9800; margin-top: 0;">Your Account Information</h3>
            <div class="info-row">
              <span class="info-label">Name:</span>
              <span class="info-value">${name}</span>
            </div>
          ...
          <div class="login-section">
            <h3 style="color: #ff9800; margin-top: 0;">🔐 New Login Credentials</h3>
            <p>You can now access the School Management System using the new password below:</p>
          ...
          <div class="important-note">
            <h4 style="color: #856404; margin-top: 0;">⚠️ Important Security Notice</h4>
            <ul style="margin: 10px 0; padding-left: 20px;">
              <li>This is your new password. Please keep it secure and do not share it with anyone.</li>
              <li>For security reasons, we recommend changing this password on your next login.</li>
              <li>If you did not request this password reset, please contact the IT department immediately.</li>
              <li>Always log out of your account when using shared computers.</li>
            </ul>
          </div>
          ...
          <ul>
            <li><strong>Login:</strong> Use the new password to access your account</li>
            <li><strong>Change Password:</strong> Consider changing your password to something more memorable</li>
            <li><strong>Review Security:</strong> Ensure your account information is up to date</li>
            <li><strong>Contact Support:</strong> If you have any issues accessing your account</li>
          </ul>

          <div class="contact-info">
            <h4 style="color: #ff9800; margin-top: 0;">📞 Need Help?</h4>
            <p>If you have any questions or need assistance, please don't hesitate to reach out:</p>
            <p><strong>IT Support:</strong> ${process.env.IT_EMAIL || 'it@school.com'}</p>
            <p><strong>Administration:</strong> ${process.env.ADMIN_EMAIL || 'admin@school.com'}</p>
          </div>
