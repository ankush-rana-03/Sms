...
const themeOptions: ThemeOptions = {
  ...
  shadows: [
    ...
    '0px 12px 16px -8px rgba(0,0,0,0.02), 0px 25px 40px 3px rgba(0,0,0,0.04), 0px 10px 48px 9px rgba(0,0,0,0.08)',
    '0px 12px 17px -8px rgba(0,0,0,0.02), 0px 26px 42px 4px rgba(0,0,0,0.04), 0px 10px 50px 9px rgba(0,0,0,0.08)',
  ],
  components: {
    MuiCssBaseline: {
      styleOverrides: {
